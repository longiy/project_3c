...
extends Node
class_name ThreeCConfigComponent

# === SIGNALS ===
signal config_changed(new_config: CharacterConfig)
signal config_applied()

# === EXPORTS ===
@export_group("Configuration")
@export var active_config: CharacterConfig
@export var auto_apply_on_ready: bool = true
@export var enable_debug_output: bool = false

# === INTERNAL STATE ===
var config_history: Array[CharacterConfig] = []
...
func setup_configuration():
	...
	if not active_config:
		...
		active_config = CharacterConfig.new()
...
func set_configuration(new_config: CharacterConfig):
...
func load_preset(preset_name: String):
	...
	var preset_config: CharacterConfig
...
func create_action_adventure_preset() -> CharacterConfig:
...
func create_fps_preset() -> CharacterConfig:
...
func create_rts_preset() -> CharacterConfig:
...
func create_platformer_preset() -> CharacterConfig:
...
func get_previous_config() -> CharacterConfig:
...
func get_active_config() -> CharacterConfig:
