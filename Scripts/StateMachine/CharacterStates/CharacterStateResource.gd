...
@export_group("Transition Conditions")
@export var can_transition_to: Array[String] = []  # ["airborne", "combat"]
@export var transition_conditions: Array[String] = []  # Human readable
...
@export var blend_parameter_path: String = ""
