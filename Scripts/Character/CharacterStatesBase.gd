# CharacterStatesBase.gd - FIXED: Working transitions enabled
...
func update(delta: float):
	...
	# FIXED: Re-enabled common transitions
	handle_common_transitions()

# === CONSOLIDATED TRANSITION LOGIC - WORKING ===

func handle_common_transitions():
	"""Handle transitions common to all states"""
...
func handle_movement_transitions():
	...
	if not is_movement_active and current_speed < movement_stop_threshold:
